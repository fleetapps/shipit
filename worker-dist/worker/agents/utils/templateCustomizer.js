 ...
 */
export function customizeTemplateFiles(templateFiles, options) {
    const customized = {};
 ...
 */
export function customizePackageJson(content, projectName) {
 ...
 */
function customizeWranglerJsonc(content, projectName) {
 ...
 */
export function generateBootstrapScript(projectName, commands) {
 ...
 */
function updateGitignore(content) {
 ...
 */
export function generateProjectName(projectName, uniqueSuffix, maxPrefixLength = 20) {
