...
export const ALL_AI_MODELS = Object.values(AIModels);
// Create tuple type for Zod enum validation
export const AI_MODELS_TUPLE = Object.values(AIModels);
export function isValidAIModel(model) {
    return Object.values(AIModels).includes(model);
}
export function getValidAIModelsArray() {
