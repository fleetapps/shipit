export function createWaitForDebugTool(agent, logger) {
    return {
        type: 'function',
        function: {
            name: 'wait_for_debug',
            description: 'Wait for the current debug session to complete. Use when deep_debug returns DEBUG_IN_PROGRESS error. Returns immediately if no debug session is running.',
            parameters: {
                type: 'object',
                properties: {},
                required: [],
