export function createWaitForGenerationTool(agent, logger) {
    return {
        type: 'function',
        function: {
            name: 'wait_for_generation',
            description: 'Wait for code generation to complete. Use when deep_debug returns GENERATION_IN_PROGRESS error. Returns immediately if no generation is running.',
            parameters: {
                type: 'object',
                properties: {},
                required: [],
