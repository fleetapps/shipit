...
export class FileProcessing {
     ...
     */
    static cleanFileContents(fileContents) {
     ...
     */
    static processGeneratedFileContents(generatedFile, originalContents, logger) {
     ...
     */
    static findFilePurpose(filePath, phase, generatedFilesMap) {
     ...
     */
    static getAllRelevantFiles(templateDetails, generatedFilesMap) {
        return this.getAllFiles(templateDetails, generatedFilesMap, true);
    }
    static getAllFiles(templateDetails, generatedFilesMap, onlyImportantFiles = false) {
