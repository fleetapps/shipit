...
export class IssueReport {
    runtimeErrors;
    staticAnalysis;
    constructor(runtimeErrors, staticAnalysis) {
     ...
     */
    static from(issues) {
        return new IssueReport(issues.runtimeErrors || [], issues.staticAnalysis || { success: false, lint: { issues: [] }, typecheck: { issues: [] } });
    }
    /**
