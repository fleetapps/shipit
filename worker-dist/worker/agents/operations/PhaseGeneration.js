import { PhaseConceptGenerationSchema } from '../schemas';
...
const issuesPromptFormatterWithGuidelines = (issues) => {
...
const userPromptFormatter = (issues, userSuggestions, isUserSuggestedPhase) => {
