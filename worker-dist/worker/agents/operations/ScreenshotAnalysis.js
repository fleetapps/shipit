...
import { AgentOperation } from './common';
...
const userPromptFormatter = (screenshotData, blueprint) => {
    ...
    async execute(input, options) {
        ...
        try {
            ...
            const messages = [
                ...
                createMultiModalUserMessage(userPromptFormatter(screenshotData, context.blueprint), screenshotData.screenshot, // The base64 data URL or image URL
