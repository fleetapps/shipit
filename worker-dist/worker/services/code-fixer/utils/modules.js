 ...
 */
export function isExternalModule(moduleSpecifier) {
 ...
 */
export function canModifyFile(filePath) {
 ...
 */
export function resolveModuleFile(moduleSpecifier, fromFilePath, context) {
 ...
 */
export function canModifyTargetFile(targetFilePath, context) {
 ...
 */
export function validateModuleOperation(moduleSpecifier, targetFilePath) {
 ...
 */
export function getModuleType(moduleSpecifier) {
    if (isExternalModule(moduleSpecifier)) {
        return 'external';
    }
