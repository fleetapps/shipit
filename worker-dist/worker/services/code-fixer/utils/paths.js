 ...
 */
export function resolvePathAlias(importSpecifier) {
 ...
 * Preserves exact logic from working implementation
 */
export function resolveImportPath(importSpecifier, currentFilePath, files) {
 ...
 */
export function findModuleFile(importSpecifier, currentFilePath, files) {
 ...
 * Preserves exact logic from working implementation
 */
export function makeRelativeImport(fromFile, toFile) {
 ...
 * Preserves exact logic from working implementation
 */
export function resolveImportToFilePath(importSpecifier, currentFilePath) {
    if (importSpecifier.startsWith('./') || importSpecifier.startsWith('../')) {
 ...
 */
export function isValidScriptPath(filePath) {
