...
export class ZipExtractor {
    ...
    static MAX_UNCOMPRESSED_SIZE = 50 * 1024 * 1024;
    ...
    // TextDecoder
    static utf8Decoder = new TextDecoder('utf-8', { fatal: true, ignoreBOM: false });
    /**
     ...
     */
    static decodeFileContents(fileContents) {
