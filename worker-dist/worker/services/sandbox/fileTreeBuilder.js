export class FileTreeBuilder {
     ...
     */
    static buildFromPaths(filePaths, options) {
        // Input validation
     ...
     * @returns Root node of the file tree
     */
    static buildFromTemplateFiles(files, options) {
     ...
     */
    static buildFromFindOutput(findOutput) {
        // Validate input
     ...
     * @returns Root node of the file tree
     */
    static buildFromPathsWithTypes(paths, filePaths, rootPath = '') {
        // Create root node
        const root = {
            path: rootPath,
            type: 'directory',
