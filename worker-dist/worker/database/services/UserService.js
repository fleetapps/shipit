...
export class UserService extends BaseService {
    ...
    async findUser(options) {
        const whereConditions = [
            ...
            options.provider ? and(eq(schema.users.provider, options.provider.name), eq(schema.users.providerId, options.provider.id)) : undefined
     ...
     */
    async updateUserProfileWithValidation(userId, profileData) {
     ...
     */
    async getUserStatisticsBasic(userId) {
