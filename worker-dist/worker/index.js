...
function setOriginControl(env, request, currentHeaders) {
 ...
 */
async function handleUserAppRequest(request, env) {
...
const worker = {
    async fetch(request, env, ctx) {
        ...
        const isMainDomainRequest = normalizedHostname === normalizedCustomDomain || normalizedHostname === 'localhost';
        const isSubdomainRequest = normalizedHostname.endsWith(`.${normalizedPreviewDomain}`) ||
