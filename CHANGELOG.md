...
* add comprehensive logging to createApp and saveToDatabase for debugging database failures ([da3faf6](https://github.com/fleetapps/shipit/commit/da3faf6a5ea8a5430aa19e3818f8717c45891bb6))
* add comprehensive step tracking logs for all 10 flow steps ([45b2ffd](https://github.com/fleetapps/shipit/commit/45b2ffda87527e5742d03485cd710d1b9db2d384))
...
* add HTTP fallback for code generation when WebSocket fails ([bdcd3f2](https://github.com/fleetapps/shipit/commit/bdcd3f2797c1a60f38136f9f0778c347c3b9d198))
* add logging to track templateDetailsCache value and template name ([6638157](https://github.com/fleetapps/shipit/commit/6638157d8426b84cb1de0c2c656d898989063764))
* add manual preview deployment button in editor view ([8ec6462](https://github.com/fleetapps/shipit/commit/8ec64623952e11c909b7eeab8e86bc451e8c1ae0))
* add real-time blueprint markdown display with typewriter effect ([6f8fa16](https://github.com/fleetapps/shipit/commit/6f8fa16d1a96315973ddc328d391c92e38ca5222))
...
* fix auth on http ([63fdb34](https://github.com/fleetapps/shipit/commit/63fdb34a01e049e9da99e7d2199a53633ec1f91c))
* store blueprint markdown and add fallback template mechanism ([58a6885](https://github.com/fleetapps/shipit/commit/58a6885ebf372a2973dbeed41e32058d75bb09fd))


### Bug Fixes

* accumulate blueprint chunks as markdown text instead of parsing JSON ([0c7a1f2](https://github.com/fleetapps/shipit/commit/0c7a1f29adf97e100381d582144ff10c8f95db0f))
...
* add auto-deployment and improve preview button visibility ([8439b85](https://github.com/fleetapps/shipit/commit/8439b859f9f34edab9deda31de6d6e6a92c81170))
...
* add comprehensive logging for blueprint stream debugging ([64c2d7e](https://github.com/fleetapps/shipit/commit/64c2d7e6f85709cdb517cea47015fdeac67120b2))
* add comprehensive logging for blueprint streaming and auth ([54e6a12](https://github.com/fleetapps/shipit/commit/54e6a127e84ed2c1b12546f0d89bd319cfbf944a))
* add comprehensive response structure logging ([b71a579](https://github.com/fleetapps/shipit/commit/b71a5795a1c8d2167895d9a000202f0961fe063e))
* add comprehensive streaming debug logs and fix chunk sending ([59e2500](https://github.com/fleetapps/shipit/commit/59e2500073c22e5a32eafc9b2b894c23ef4f36c5))
* add critical logging to debug app creation failure ([e6b2a59](https://github.com/fleetapps/shipit/commit/e6b2a59e7737667cb54b0ad443d6ded644332d19))
...
* add direct DB query fallback for templateName retrieval ([0f2bda0](https://github.com/fleetapps/shipit/commit/0f2bda0a30c68bdf6bdba1842c3e9ec24e4973ac))
...
* add null check for phase generation and file generation logging ([52a6772](https://github.com/fleetapps/shipit/commit/52a6772e53cecc6ddddddcc2da4bbffd5c79498a))
...
* agent initialization null destructuring error ([f4c77b5](https://github.com/fleetapps/shipit/commit/f4c77b588bdc92737a6ba5896e448f13511331e2))
...
* Always use cookie as source of truth, never fallback to in-memory token. ([88f4c19](https://github.com/fleetapps/shipit/commit/88f4c194f5028c17f830f32df473942c3b408258))
* **auth:** resolve CSRF validation failures and WebSocket authentication ([88f4c19](https://github.com/fleetapps/shipit/commit/88f4c194f5028c17f830f32df473942c3b408258))
* **auth:** use correct logger reference in CSRF token endpoint ([caa8ca9](https://github.com/fleetapps/shipit/commit/caa8ca9eef95cb850ed61a27238e8ea3eaa33ec0))
...
* await ensureTemplateDetails in onConnect before getTemplateDetails ([cb9e4cf](https://github.com/fleetapps/shipit/commit/cb9e4cfcbf3a474d0dc76a6e9574f933ae7fc59a))
* change all LLM models to Claude (Claude 4 Sonnet primary, Claude 3.5 Sonnet fallback) ([ae11a5c](https://github.com/fleetapps/shipit/commit/ae11a5c782b740eb1cf5ee39c94db6d192932a9f))
...
* complete websocket error response handling ([c66159b](https://github.com/fleetapps/shipit/commit/c66159b113642b3f35405a321400a371c0db347d))
...
* comprehensive fixes for WebSocket auth, preview button, and blueprint ([c9a6283](https://github.com/fleetapps/shipit/commit/c9a6283ef4fb117b376664b15e6e2ff3f84f7e31))
...
* correct DO ID extraction in onConnect() to use .name property ([ef3fccc](https://github.com/fleetapps/shipit/commit/ef3fcccdeafd13e96e55702a6b472dcfb460a074))
* correct stream extraction from Response object ([c99d589](https://github.com/fleetapps/shipit/commit/c99d589f9441021984ced902663fb7280e82c47e))
* correct TypeScript types for streaming response ([929bee3](https://github.com/fleetapps/shipit/commit/929bee3ca909cfc370da81a75cb523bcbaad7c4c))
* correct variable name for stream detection (isStreamResponse instead of isStream) ([4c75b6c](https://github.com/fleetapps/shipit/commit/4c75b6c4d85aa68c8b69c3404735821651b597d3))
* correct variable reference in error log (doIdName) ([2121d13](https://github.com/fleetapps/shipit/commit/2121d13cfa047631683e6aac6d430774a62811c1))
* create app record immediately after agentId generation to prevent 404 errors ([19c7448](https://github.com/fleetapps/shipit/commit/19c7448d4b33460a7afb6ecb6056ad06245532c2))
* **csrf:** restore fallback and prevent middleware conflict ([7156312](https://github.com/fleetapps/shipit/commit/7156312ac77f9fe47fdc2759cd2319bf18e0ea1d))
...
* ensure agentId is never empty when querying database ([4604ad1](https://github.com/fleetapps/shipit/commit/4604ad17b7ff1cbba362531e66227220c331920e))
* ensure app creation succeeds with retry logic and auto-initialize agent in generate endpoint ([4448eaf](https://github.com/fleetapps/shipit/commit/4448eaf5fdd6b234a3fd3e0231ac651d55873e0a))
...
* handle empty streams and ensure content is always chunked ([68282ac](https://github.com/fleetapps/shipit/commit/68282ac6eaa3e77d507f0adecb8e0d43af505d9e))
...
* handle missing inferenceContext when getting agentId ([678a4e0](https://github.com/fleetapps/shipit/commit/678a4e01cf6e98030a29a0d8ace70f730ac51fed))
...
* handle missing templateName in ensureTemplateDetails ([c1fdda6](https://github.com/fleetapps/shipit/commit/c1fdda6b9a2a9ce6cb8641b0a915de0df23a582c))
* implement WebSocket authentication using authUtils query parameter ([d37a549](https://github.com/fleetapps/shipit/commit/d37a54906249baa4b1ce34e81715b4ed393a227f))
* improve auth token detection and blueprint logging ([ee9a22b](https://github.com/fleetapps/shipit/commit/ee9a22bbd8b2099f4188411ccc13e7b9f669f760))
...
* improve templateName fallback with better logging and error handling ([63e6598](https://github.com/fleetapps/shipit/commit/63e6598e11469d59a6228d6c7cc796eab1c2ef78))
...
* make getAgentId() safe during initialization ([4593e2f](https://github.com/fleetapps/shipit/commit/4593e2f15d920e71d01025f68d68c4689225ad07))
* make logger() safe during initialization ([f976d6d](https://github.com/fleetapps/shipit/commit/f976d6d6246f1d4470e5df41145d359c480ee72f))
...
* manually stream content when structured output returns non-stream response ([da3dd84](https://github.com/fleetapps/shipit/commit/da3dd84bc72c3d742fbd512ffe0d337e361f8f3d))
...
* pass Response object to ndjsonStream instead of ReadableStream ([b8961a6](https://github.com/fleetapps/shipit/commit/b8961a650951903dba8bf30a9626369da812810c))
* prevent empty templateName error in ensureTemplateDetails() ([e05daa1](https://github.com/fleetapps/shipit/commit/e05daa11eaece04845378e7632014d1ca63869ef))
* prioritize DO ID name as source of truth for agentId ([aa0e0ae](https://github.com/fleetapps/shipit/commit/aa0e0ae5ba2566e68b48fd37e241cf2e93105a84))
* read CSRF token from cookie instead of in-memory cache ([9beeb4f](https://github.com/fleetapps/shipit/commit/9beeb4fd5f332537dbed00dd78e5e60297ef405b))
* remove infinite recursion in getAgentId() logger calls ([5f36948](https://github.com/fleetapps/shipit/commit/5f3694813f07c904a4a7f8e47b27c87aa3bba067))
...
* set cookie domain for cross-subdomain auth access ([e3a1d4f](https://github.com/fleetapps/shipit/commit/e3a1d4f77d23b200cbaf6002cc0b130f1c8d6a19))
* set CSRF cookie domain for cross-subdomain access ([3193679](https://github.com/fleetapps/shipit/commit/319367909efbae09263e106a4dc8d4aaa4db0566))
...
* set templateDetailsCache immediately at start of initialize() ([ddff6eb](https://github.com/fleetapps/shipit/commit/ddff6ebb5b1ea034c7abd61143af7a4e7fc9e0c4))
...
* simplify ensureTemplateDetails() to match original pattern ([ce38e84](https://github.com/fleetapps/shipit/commit/ce38e843b39b18c75edca22cc8ab6a5768fb1358))
* store templateName immediately to prevent missing template errors ([c2df3ba](https://github.com/fleetapps/shipit/commit/c2df3badd896f599590f5e1396d0fc65310f9571))
...
* update blueprint model to Claude 4 Sonnet ([d8ab15c](https://github.com/fleetapps/shipit/commit/d8ab15c367f34c46742bbc6809253c3484aa12e4))
...
* validate token for public routes to set user in context ([a6631a7](https://github.com/fleetapps/shipit/commit/a6631a7950078124e7445cc9a6d404658682e2a0))
* websocket authentication and cookie handling ([151f0e7](https://github.com/fleetapps/shipit/commit/151f0e7b4bf66e927667855042bc7c8c7fb4f1fc))
* websocket authentication for anonymous users ([b54946e](https://github.com/fleetapps/shipit/commit/b54946e400ee95823fe06fcce4e28492f7ff5df8))
* websocket error responses for anonymous users ([4f52eb7](https://github.com/fleetapps/shipit/commit/4f52eb7d75226fd2579f842a26b9cf0718745bc6))
